...
def save_as(mainapp):
	...
	mainapp.save_file = r'C:\Users\domhn\Documents\Python\Pycabin_Tkinter\V0.17\test.json'
...
def load(event=None, mainapp=None):
	...
	with open(r'C:\Users\domhn\Documents\Python\Pycabin_Tkinter\V0.17\test.json') as f:
